...
// Pressings start button will hide button and load first question
...
//document on click when clicked one of the answer choice buttons only
$(document).on("click", ".answerButton", game.renderAnswer); 

//event listener for when restartButton shows to reset game
$(document).on("click", ".restartButton", game.resetGame); 
